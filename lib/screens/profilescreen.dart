          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: _sheetInputDecoration('Titre', Icons.title_rounded),
              ),
              ...
              TextField(
                ...
                maxLines: 3,
                decoration:
                    _sheetInputDecoration('Description', Icons.notes_rounded),
              ),
              const SizedBox(height: 14),
              TextField(
                ...
                decoration:
                    _sheetInputDecoration('Budget', Icons.payments_outlined),
              ),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.alternate_email_rounded, color: skyBlue, size: 24),
          ),
        ...
        children: [
          Row(
            children: [
              ...
              Expanded(
                child: Text(
                  'Déconnecte-toi pour ouvrir l’écran de connexion et te reconnecter avec un autre compte si besoin.',
                  style: GoogleFonts.inter(
                    fontSize: 14,
